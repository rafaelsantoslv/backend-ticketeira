package com.unyx.ticketeira.constant;

public class SystemMessages {

    // NOT FOUND
    public static final String USER_NOT_FOUND = "O usuário informado não foi encontrado";
    public static final String EVENT_NOT_FOUND = "O evento informado não foi encontrado";
    public static final String BATCH_NOT_FOUND = "O lote informado não foi encontrado";
    ...
    public static final String EMAIL_ACCESS_DENIED = "O email informado está em uso";
    public static final String DOCUMENT_ACCESS_DENIED = "O documento informado está em uso";
    ...
    public static final String EVENT_SUCCESS = "Sucesso ao criar o evento";
    public static final String SECTOR_SUCCESS = "Sucesso ao criar o setor";
    public static final String BATCH_SUCCESS = "Sucesso ao criar o batch";
}
